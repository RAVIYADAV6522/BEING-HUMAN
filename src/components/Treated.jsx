...
export default function Treated({src1,matter,date,healthcareName,treatedDate}) {
  return (
    <>
      <div>
        <div className=" min-w-[570px] md:py-[80] py-5 flex max-auto sm:flex-row flex-col rounded-lg bg-green-600 px-10 mx-7 my-3 transform transition-transform duration-300 hover:scale-110">
        <div>
